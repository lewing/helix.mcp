...
- **Historical perf/testing guidance (2025-07-18/24):** Performance work targeted 17 allocation issues, and the tautological-test review removed redundant tests with no coverage loss. Prefer allocation-conscious changes and avoid layer-duplicate tests.
